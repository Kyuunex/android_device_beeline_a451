...
ifeq ($(BUILDING_TWRP),false)
# The gps config appropriate for this device
$(call inherit-product, device/common/gps/gps_us_supl.mk)
endif

$(call inherit-product-if-exists, vendor/beeline/a451/a451-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/beeline/a451/overlay
PRODUCT_PACKAGE_OVERLAYS += device/beeline/a451/overlay # enable this to be able overlay a default wallpaper

LOCAL_PATH := device/beeline/a451
